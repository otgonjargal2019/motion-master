    ...
    <div>
      ...
      <footer className="footer">
        ...
        <div className="bottom-part">
          ...
          <div className="h-[1px] bg-[#888888]"></div>
          <p className="text-white text-[20px] font-bold mt-8 mb-4">
            엘에스웨어(주)
          </p>
          <ul className="text-[#C4C4C4] text-[20px] font-medium flex flex-wrap gap-12">
            <li>대표자명 : 김민수</li>
            <li>
